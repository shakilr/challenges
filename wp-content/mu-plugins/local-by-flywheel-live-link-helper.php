...
class LocalWP_Live_Link_Helper {
	 ...
	 *
	 * @param $old string Host to be replaced
	 * @param $new string Host to use as replacement
	 * @param $subject string Replacement subject
	 */
	 ...
	 *
	 * @param $str string String provided by the filter
	 *
	...
	/**
	 * Convert tunnel domain back to the site's local hostname when saving to the database.
	 */
	public function make_link_local( $str ) {
